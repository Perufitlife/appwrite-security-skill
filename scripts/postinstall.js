...
const lines = [
  "",
  "  +-------------------------------------------------------------------------+",
  "  |  + appwrite-security installed                                                       ",
  "  |                                                                          ",
  "  |  Run it now (creds never persisted):                                     ",
  "  |    npx appwrite-security --endpoint https://cloud.appwrite.io/v1 --project XXX --key XXX",
  "  |                                                                          ",
  "  |  No-install version (browser):                                           ",
  "  |    https://apify.com/renzomacar/appwrite-security-auditor",
  "  |                                                                          ",
